let chatMessageHandler = chatMsg => {
  ...
  console.log(chatMsg.toObject());
};
// 8954.6ca5bd48.js
(self.__LOADABLE_LOADED_CHUNKS__ = self.__LOADABLE_LOADED_CHUNKS__ || []).push([[8954], {
  75397: function(e, t, a) {
      "use strict";
      a.d(t, {
          Kr: function() {
              return r.Kr
  ...
  33561: function(e, t, a) {
      "use strict";
      a.r(t),
      a.d(t, {
          ActivityInteractiveMessage: function() {
              return n.ActivityInteractiveMessage
          },
          AdminData: function() {
              return g.AdminData
          },
          AdminPrivilegeMessage: function() {
              return u.AdminPrivilegeMessage
          },
          AdminPrivilegeStruct: function() {
              return u.AdminPrivilegeStruct
          },
          AdminRecordHandleMessage: function() {
              return c.AdminRecordHandleMessage
          },
          AdminRecordMessage: function() {
              return g.AdminRecordMessage
          },
          AllQuizInfo: function() {
              return Va.AllQuizInfo
          },
          AnchorAppointmentNumUpdateMessage: function() {
              return to.AnchorAppointmentNumUpdateMessage
          },
          AnchorBoost: function() {
              return p.AnchorBoost
          },
          AnchorBoostMessage: function() {
              return p.AnchorBoostMessage
          },
          AnchorFaceConfig: function() {
              return Ya.AnchorFaceConfig
          },
          AnchorUpdateLayoutContent: function() {
              return Dt.AnchorUpdateLayoutContent
          },
          AnchorUpdateLinkmicConfigContent: function() {
              return Dt.AnchorUpdateLinkmicConfigContent
          },
          AnswerReviewMessage: function() {
              return f.AnswerReviewMessage
          },
          AppointmentNumberUpdateMessage: function() {
              return ao.AppointmentNumberUpdateMessage
          },
          AssetEffectUtilMessage: function() {
              return l.AssetEffectUtilMessage
          },
          AssetMessage: function() {
              return y.AssetMessage
          },
          AuctionInfo: function() {
              return aa.AuctionInfo
          },
          AuctionSuccess: function() {
              return aa.AuctionSuccess
          },
          AudienceEntranceMessage: function() {
              return xr.AudienceEntranceMessage
          },
          AudienceOrderSongChatContent: function() {
              return ft.AudienceOrderSongChatContent
          },
          AudienceOrderSongContent: function() {
              return ft.AudienceOrderSongContent
          },
          AudioBGImgMessage: function() {
              return h.AudioBGImgMessage
          },
          AudioChatMessage: function() {
              return M.AudioChatMessage
          },
          AuthorizationNotifyMessage: function() {
              return w.AuthorizationNotifyMessage
          },
          AutoCoverMessage: function() {
              return b.AutoCoverMessage
          },
          Avatar: function() {
              return ya.Avatar
          },
          AwemeShopExplainMessage: function() {
              return I.AwemeShopExplainMessage
          },
          BackRecordVideoMessage: function() {
              return C.BackRecordVideoMessage
          },
          Background: function() {
              return Lr.Background
          },
          BattleCancelMessage: function() {
              return m.BattleCancelMessage
          },
          BattleFeedBackCardMessage: function() {
              return L.BattleFeedBackCardMessage
          },
          BattleFrontRankMessage: function() {
              return S.BattleFrontRankMessage
          },
          BattleInviteMessage: function() {
              return F.BattleInviteMessage
          },
          BattleMode: function() {
              return Pt.BattleMode
          },
          BattleModeMessage: function() {
              return D.BattleModeMessage
          },
          BattleMultiMatchMessage: function() {
              return k.BattleMultiMatchMessage
          },
          BattleNotifyMessage: function() {
              return B.BattleNotifyMessage
          },
          BattlePrecisionMatchMessage: function() {
              return P.BattlePrecisionMatchMessage
          },
          BattleRejectMessage: function() {
              return E.BattleRejectMessage
          },
          BattleSettings: function() {
              return Pt.BattleSettings
          },
          BattleTask: function() {
              return Pt.BattleTask
          },
          BattleTeamTaskAskMessage: function() {
              return G.BattleTeamTaskAskMessage
          },
          BattleTeamTaskMessage: function() {
              return R.BattleTeamTaskMessage
          },
          BattleUseCardMessage: function() {
              return T.BattleUseCardMessage
          },
          BeginnerGuideMessage: function() {
              return W.BeginnerGuideMessage
          },
          BenefitLabel: function() {
              return aa.BenefitLabel
          },
          BindingGiftMessage: function() {
              return _e.BindingGiftMessage
          },
          BridgeData: function() {
              return z.BridgeData
          },
          BridgeMessage: function() {
              return z.BridgeMessage
          },
          BrokerNotifyMessage: function() {
              return Se.BrokerNotifyMessage
          },
          BrotherhoodMessage: function() {
              return U.BrotherhoodMessage
          },
          BubbleConfig: function() {
              return Xr.BubbleConfig
          },
          ...
          CarSeriesInfoMessage: function() {
              return O.CarSeriesInfoMessage
          },
          CategoryChangeMessage: function() {
              return N.CategoryChangeMessage
          },
          CategoryInfo: function() {
              return ra.CategoryInfo
          },
          CeremonyMessage: function() {
              return ne.CeremonyMessage
          },
          ChannelLinkerApplyContent: function() {
              return St.ChannelLinkerApplyContent
          },
          ChannelLinkerCloseContent: function() {
              return St.ChannelLinkerCloseContent
          },
          ChannelLinkerCreateContent: function() {
              return St.ChannelLinkerCreateContent
          },
          ChannelLinkerEnterContent: function() {
              return St.ChannelLinkerEnterContent
          },
          ChannelLinkerInviteContent: function() {
              return St.ChannelLinkerInviteContent
          },
          ChannelLinkerKickOutContent: function() {
              return St.ChannelLinkerKickOutContent
          },
          ChannelLinkerLeaveContent: function() {
              return St.ChannelLinkerLeaveContent
          },
          ChannelLinkerLinkedListChangeContent: function() {
              return St.ChannelLinkerLinkedListChangeContent
          },
          ChannelLinkerPermitContent: function() {
              return St.ChannelLinkerPermitContent
          },
          ChannelLinkerReplyContent: function() {
              return St.ChannelLinkerReplyContent
          },
          ChannelLinkerSilenceContent: function() {
              return St.ChannelLinkerSilenceContent
          },
          ChannelNoticeContent: function() {
              return Dt.ChannelNoticeContent
          },
          ChatCarnivalMessage: function() {
              return j.ChatCarnivalMessage
          },
          ChatItem: function() {
              return j.ChatItem
          },
          ...
          GuideMessage: function() {
              return Ye.GuideMessage
          },
          HighlightComment: function() {
              return Xe.HighlightComment
          },
          HighlightCommentPosition: function() {
              return Ze.HighlightCommentPosition
          },
          HostVersion: function() {
              return Be.HostVersion
          },
          HotAtmosphere: function() {
              return aa.HotAtmosphere
          },
          HotChatMessage: function() {
              return qe.HotChatMessage
          },
          HotLiveModule: function() {
              return ya.HotLiveModule
          },
          HotRoomMessage: function() {
              return et.HotRoomMessage
          },
          HotVideoCard: function() {
              return ya.HotVideoCard
          },
          ...
          ScreenChatMessage: function() {
              return kr.ScreenChatMessage
          },
          SetSettingOrderSongContent: function() {
              return ft.SetSettingOrderSongContent
          },
          ShareGuideMessage: function() {
              return Br.ShareGuideMessage
          },
          SharePosterMessage: function() {
              return Pr.SharePosterMessage
          },
          ShortTouchAreaMessage: function() {
              return Er.ShortTouchAreaMessage
          },
          ShowChatMessage: function() {
              return Gr.ShowChatMessage
          },
          ShowDouPlusNotifyMessage: function() {
              return Rr.ShowDouPlusNotifyMessage
          },
          ShowEffectMessage: function() {
              return Tr.ShowEffectMessage
          },
          ShowLinkedLiveRoomsMessage: function() {
              return Wr.ShowLinkedLiveRoomsMessage
          },
          ShowMultiCameraChangeMessage: function() {
              return vr.ShowMultiCameraChangeMessage
          },
          ShowWatchInfoMessage: function() {
              return zr.ShowWatchInfoMessage
          },
          SimpleGameInfo: function() {
              return ve.SimpleGameInfo
          },
          SkuInfo: function() {
              return aa.SkuInfo
          },
          SkyEyeAnchorSetMessage: function() {
              return Ur.SkyEyeAnchorSetMessage
          },
          SocialMessage: function() {
              return Ar.SocialMessage
          },
          SpecialPushMessage: function() {
              return Or.SpecialPushMessage
          },
          SportsQuiz: function() {
              return jr.SportsQuiz
          },
          SportsQuizMessage: function() {
              return jr.SportsQuizMessage
          },
          SportsQuizOption: function() {
              return jr.SportsQuizOption
          },
          StampMessage: function() {
              return xr.StampMessage
          },
          StarProfile: function() {
              return ya.StarProfile
          },
          StreamControlMessage: function() {
              return _r.StreamControlMessage
          },
          SubscribeAssetMessage: function() {
              return Vr.SubscribeAssetMessage
          },
          SubscribeInfoMessage: function() {
              return Vr.SubscribeInfoMessage
          },
          SunDailyRankMessage: function() {
              return Hr.SunDailyRankMessage
          },
          SwitchEarphoneMonitorContent: function() {
              return v.SwitchEarphoneMonitorContent
          },
          SwitchFullSongStatusContent: function() {
              return v.SwitchFullSongStatusContent
          },
          SwitchKtvModeContent: function() {
              return v.SwitchKtvModeContent
          },
          SwitchLyricStatusContent: function() {
              return v.SwitchLyricStatusContent
          },
          SwitchSceneContent: function() {
              return v.SwitchSceneContent
          },
          SwitchTuningEffectContent: function() {
              return v.SwitchTuningEffectContent
          },
          SyncStreamInfoMessage: function() {
              return Kr.SyncStreamInfoMessage
          },
          SyncStreamMessage: function() {
              return Kr.SyncStreamMessage
          },
          SystemMessage: function() {
              return Jr.SystemMessage
          },
          TaskMessage: function() {
              return $r.TaskMessage
          },
          TaskPanel: function() {
              return X.TaskPanel
          },
          TaskPanelMessage: function() {
              return X.TaskPanelMessage
          },
          TaskRewardToast: function() {
              return X.TaskRewardToast
          },
          TaskRewardToastMessage: function() {
              return X.TaskRewardToastMessage
          },
          Team: function() {
              return ya.Team
          },
          TempStateAreaReachMessage: function() {
              return we.TempStateAreaReachMessage
          },
          TextExtraItem: function() {
              return g.TextExtraItem
          },
          ToastMessage: function() {
              return Qr.ToastMessage
          },
          ToolBarControlMessage: function() {
              return Yr.ToolBarControlMessage
          },
          ToolbarItemBehaviourParam: function() {
              return Xr.ToolbarItemBehaviourParam
          },
          ToolbarItemBehaviourParams: function() {
              return Xr.ToolbarItemBehaviourParams
          },
          ToolbarItemMessage: function() {
              return Xr.ToolbarItemMessage
          },
          TopLeftBubbleMessage: function() {
              return Zr.TopLeftBubbleMessage
          },
          TraceTimeMetric: function() {
              return aa.TraceTimeMetric
          },
          TurntableBurstMessage: function() {
              return qr.TurntableBurstMessage
          },
          UnionGeneralMessage: function() {
              return eo.UnionGeneralMessage
          },
          UpIcon: function() {
              return aa.UpIcon
          },
          UpdateFanTicketMessage: function() {
              return ro.UpdateFanTicketMessage
          },
          UpdateKoiRoomStatusMessage: function() {
              return Nr.UpdateKoiRoomStatusMessage
          },
          UpdatedCampaignInfo: function() {
              return aa.UpdatedCampaignInfo
          },
          UpdatedCartInfo: function() {
              return aa.UpdatedCartInfo
          },
          UpdatedCommentaryVideoInfo: function() {
              return aa.UpdatedCommentaryVideoInfo
          },
          UpdatedCouponInfo: function() {
              return aa.UpdatedCouponInfo
          },
          UpdatedGroupInfo: function() {
              return aa.UpdatedGroupInfo
          },
          UpdatedProductInfo: function() {
              return aa.UpdatedProductInfo
          },
          UpdatedSkuInfo: function() {
              return aa.UpdatedSkuInfo
          },
          UploadCoverMessage: function() {
              return oo.UploadCoverMessage
          },
          UpperRightWidgetDataMessage: function() {
              return no.UpperRightWidgetDataMessage
          },
          UserBid: function() {
              return aa.UserBid
          },
          UserContribute: function() {
              return Ft.UserContribute
          },
          UserInfo: function() {
              return Me.UserInfo
          },
          UserPrivilegeChangeMessage: function() {
              return io.UserPrivilegeChangeMessage
          },
          UserRoom: function() {
              return ne.UserRoom
          },
          UserStatsMessage: function() {
              return so.UserStatsMessage
          },
          VIPInfoMessage: function() {
              return go.VIPInfoMessage
          },
          VIPSeatMessage: function() {
              return go.VIPSeatMessage
          },
          VSLinkRoomMessage: function() {
              return fo.VSLinkRoomMessage
          },
          VenueInfo: function() {
              return ya.VenueInfo
          },
          VerificationCodeMessage: function() {
              return uo.VerificationCodeMessage
          },
          VideoCard: function() {
              return ya.VideoCard
          },
          VideoCardModule: function() {
              return ya.VideoCardModule
          },
          VideoLiveCouponRcmdMessage: function() {
              return Po.VideoLiveCouponRcmdMessage
          },
          VideoLiveGoodsOrderMessage: function() {
              return Po.VideoLiveGoodsOrderMessage
          },
          VideoLiveGoodsRcmdMessage: function() {
              return Po.VideoLiveGoodsRcmdMessage
          },
          VideoShareMessage: function() {
              return co.VideoShareMessage
          },
          VideoSize: function() {
              return ya.VideoSize
          },
          VsInteractiveMessage: function() {
              return po.VsInteractiveMessage
          },
          VsPanelMessage: function() {
              return lo.VsPanelMessage
          },
          WebcastBattleBonusMessage: function() {
              return yo.WebcastBattleBonusMessage
          },
          WebcastBattlePropertyMessage: function() {
              return ho.WebcastBattlePropertyMessage
          },
          WebcastPopularCardMessage: function() {
              return Do.WebcastPopularCardMessage
          },
          WelfareProjectOperateMessage: function() {
              return ko.WelfareProjectOperateMessage
          },
          WinLotteryAlert: function() {
              return aa.WinLotteryAlert
          },
          WinLotteryInfo: function() {
              return aa.WinLotteryInfo
          },
          WishFinishMessage: function() {
              return Bo.WishFinishMessage
          },
          Word: function() {
              return xa.Word
          },
          XGLotteryMessage: function() {
              return ia.XGLotteryMessage
          },
          default: function() {
              return Ro
          },
  ...
  91148: function(e, t, a) {
      ...
      .call(null);
      o.exportSymbol("proto.webcast.data.BottomRightCardArea", null, n),
      o.exportSymbol("proto.webcast.data.CardCondition", null, n),
      o.exportSymbol("proto.webcast.data.CardCondition.ConditionType", null, n),
      o.exportSymbol("proto.webcast.data.CardDisplayInfo", null, n),
      o.exportSymbol("proto.webcast.data.CardDisplayInfo.ContainerType", null, n),
      o.exportSymbol("proto.webcast.data.CardPreDefeatStrategy", null, n),
      o.exportSymbol("proto.webcast.data.CardPreDefeatStrategy.StrategyType", null, n),
      o.exportSymbol("proto.webcast.data.CardShowDefeatStrategy", null, n),
      o.exportSymbol("proto.webcast.data.CardShowDefeatStrategy.StrategyType", null, n),
      o.exportSymbol("proto.webcast.data.CardTrigger", null, n),
      o.exportSymbol("proto.webcast.data.CardTrigger.TriggerType", null, n),
      o.exportSymbol("proto.webcast.data.CardTriggerConfig", null, n),
  ...
  6211: function(e, t, a) {
      ...
      o.exportSymbol("proto.webcast.data.ItemDetail", null, n),
      o.exportSymbol("proto.webcast.data.MarkDetail", null, n),
      o.exportSymbol("proto.webcast.data.PriceInfo", null, n),
      ...
      proto.webcast.data.PriceInfo.toObject = function(e, t) {
          var a = {
              pricelistList: r.Message.toObjectList(t.getPricelistList(), i.StandardMoney.toObject, e)
          };
          return e && (a.$jspbMessageInstance = t),
          a
      }
      ...
      proto.webcast.data.PriceInfo.deserializeBinaryFromReader = function(e, t) {
          for (; t.nextField() && !t.isEndGroup(); ) {
              if (1 === t.getFieldNumber()) {
                  var a = new i.StandardMoney;
                  t.readMessage(a, i.StandardMoney.deserializeBinaryFromReader),
                  e.addPricelist(a)
              } else
                  t.skipField()
          }
      ...
      proto.webcast.data.PriceInfo.serializeBinaryToWriter = function(e, t) {
          var a = undefined;
          (a = e.getPricelistList()).length > 0 && t.writeRepeatedMessage(1, a, i.StandardMoney.serializeBinaryToWriter)
      }
      ,
      proto.webcast.data.PriceInfo.prototype.getPricelistList = function() {
          return r.Message.getRepeatedWrapperField(this, i.StandardMoney, 1)
      }
      ,
  ...
  92596: function(e, t, a) {
      ...
      .call(null)
        , i = a(62507);
      o.object.extend(proto, i),
      o.exportSymbol("proto.webcast.data.ChatEmojiGuideInfo", null, n),
      o.exportSymbol("proto.webcast.data.ChatEmojiGuideInfo.EmojiGuideConf", null, n),
      o.exportSymbol("proto.webcast.data.ChatImageGuideInfo", null, n),
      o.exportSymbol("proto.webcast.data.ChatImageGuideInfo.ImageGuideConf", null, n),
      o.exportSymbol("proto.webcast.data.LikeIconInfo", null, n),
      o.exportSymbol("proto.webcast.data.MatchChatInfo", null, n),
      ...
      proto.webcast.data.LikeIconInfo.toObject = function(e, t) {
          var a = {
              iconsList: r.Message.toObjectList(t.getIconsList(), i.Image.toObject, e)
          };
          return e && (a.$jspbMessageInstance = t),
          a
      }
      ...
      proto.webcast.data.LikeIconInfo.deserializeBinaryFromReader = function(e, t) {
          for (; t.nextField() && !t.isEndGroup(); ) {
              if (1 === t.getFieldNumber()) {
                  var a = new i.Image;
                  t.readMessage(a, i.Image.deserializeBinaryFromReader),
                  e.addIcons(a)
              } else
                  t.skipField()
          }
      ...
      proto.webcast.data.LikeIconInfo.serializeBinaryToWriter = function(e, t) {
          var a = undefined;
          (a = e.getIconsList()).length > 0 && t.writeRepeatedMessage(1, a, i.Image.serializeBinaryToWriter)
      }
      ,
      proto.webcast.data.LikeIconInfo.prototype.getIconsList = function() {
          return r.Message.getRepeatedWrapperField(this, i.Image, 1)
      }
      ,
      ...
      proto.webcast.data.ChatImageGuideInfo.ImageGuideConf.toObject = function(e, t) {
          var a, o = {
              ...
              image: (a = t.getImage()) && i.Image.toObject(e, a),
      ...
      proto.webcast.data.ChatImageGuideInfo.ImageGuideConf.serializeBinaryToWriter = function(e, t) {
          ...
          null != (a = e.getImage()) && t.writeMessage(2, a, i.Image.serializeBinaryToWriter),
      ...
      proto.webcast.data.ChatImageGuideInfo.ImageGuideConf.prototype.getImage = function() {
          return r.Message.getWrapperField(this, i.Image, 2)
      }
      ,
      ...
      proto.webcast.data.MatchChatInfo.toObject = function(e, t) {
          var a, o = {
              mainGroupIcon: (a = t.getMainGroupIcon()) && i.Image.toObject(e, a),
              mainGroupBackground: (a = t.getMainGroupBackground()) && i.Image.toObject(e, a),
              guestGroupIcon: (a = t.getGuestGroupIcon()) && i.Image.toObject(e, a),
              guestGroupBackground: (a = t.getGuestGroupBackground()) && i.Image.toObject(e, a),
              aggregateIconList: r.Message.toObjectList(t.getAggregateIconList(), i.Image.toObject, e)
          };
          return e && (o.$jspbMessageInstance = t),
          o
      }
      ...
      proto.webcast.data.MatchChatInfo.serializeBinaryToWriter = function(e, t) {
          var a = undefined;
          null != (a = e.getMainGroupIcon()) && t.writeMessage(1, a, i.Image.serializeBinaryToWriter),
          null != (a = e.getMainGroupBackground()) && t.writeMessage(2, a, i.Image.serializeBinaryToWriter),
          null != (a = e.getGuestGroupIcon()) && t.writeMessage(3, a, i.Image.serializeBinaryToWriter),
          null != (a = e.getGuestGroupBackground()) && t.writeMessage(4, a, i.Image.serializeBinaryToWriter),
          (a = e.getAggregateIconList()).length > 0 && t.writeRepeatedMessage(5, a, i.Image.serializeBinaryToWriter)
      }
      ,
      proto.webcast.data.MatchChatInfo.prototype.getMainGroupIcon = function() {
          return r.Message.getWrapperField(this, i.Image, 1)
      }
      ,
      ...
      proto.webcast.data.MatchChatInfo.prototype.getAggregateIconList = function() {
          return r.Message.getRepeatedWrapperField(this, i.Image, 5)
      }
      ,
  ...
  78389: function(e, t, a) {
      ...
      .call(null)
        , i = a(62507);
      o.object.extend(proto, i),
      o.exportSymbol("proto.webcast.data.SelfDisciplineLikeSource", null, n),
      o.exportSymbol("proto.webcast.data.SelfDisciplineLikeStatus", null, n),
      o.exportSymbol("proto.webcast.data.SelfDisciplinePrivacyStatus", null, n),
      o.exportSymbol("proto.webcast.data.SelfDisciplineSwitchStatus", null, n),
      o.exportSymbol("proto.webcast.data.SelfDisciplineUserBase", null, n),
      o.exportSymbol("proto.webcast.data.SelfDisciplineUserBase.FollowInfo", null, n),
      ...
      proto.webcast.data.SelfDisciplineUserBase.serializeBinaryToWriter = function(e, t) {
          ...
          null != (a = e.getAvatarThumb()) && t.writeMessage(3, a, i.Image.serializeBinaryToWriter),
  ...
  11874: function(e, t, a) {
      ...
      .call(null);
      o.exportSymbol("proto.webcast.data.CandidateUser", null, n),
      o.exportSymbol("proto.webcast.data.ExpandLotteryConfig", null, n),
      o.exportSymbol("proto.webcast.data.ExpandPrizeType", null, n),
      o.exportSymbol("proto.webcast.data.GiftInfo", null, n),
      o.exportSymbol("proto.webcast.data.LotteryCondition", null, n),
      o.exportSymbol("proto.webcast.data.LotteryConfig", null, n),
      o.exportSymbol("proto.webcast.data.LotteryDefaultConfig", null, n),
      o.exportSymbol("proto.webcast.data.LotteryExpandActivityInfo", null, n),
      o.exportSymbol("proto.webcast.data.LotteryFansLevelConfig", null, n),
      o.exportSymbol("proto.webcast.data.LotteryGiftGuide", null, n),
      o.exportSymbol("proto.webcast.data.LotteryInfo", null, n),
      o.exportSymbol("proto.webcast.data.LotteryLuckyUser", null, n),
      o.exportSymbol("proto.webcast.data.LotteryPrize", null, n),
      o.exportSymbol("proto.webcast.data.LotteryRewardDetail", null, n),
      o.exportSymbol("proto.webcast.data.LotteryUserCondition", null, n),
      ...
      ,
      proto.webcast.data.LotteryConfig.repeatedFields_ = [3, 1, 2, 7, 8, 9, 10, 11, 12, 14, 17, 21],
  ...
  29946: function(e, t, a) {
      ...
      .call(null);
      o.exportSymbol("proto.webcast.data.ProfitInteractionSetting", null, n),
